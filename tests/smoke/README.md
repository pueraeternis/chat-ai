...
| 2 | Client function calling | `check_proxy_function_calling.sh` | 300s |
| 3 | System `web_search` | `check_proxy_web_search.sh` | `SMOKE_WEB_SEARCH_CURL_MAX_TIME` (600s) |
| 4 | Vision (`image_url`) | `check_proxy_vision.sh` | 300s; uses `tests/test_image.jpg` (base64, no network) |
